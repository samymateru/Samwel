...
from schemas.attachement_schemas import ReadAttachment, CreateAttachment
...
class NewIssueResponse(BaseModel):
    ...
    attachments: Optional[CreateAttachment] = None
...
class ReadIssueResponseV2(BaseIssueResponse):
    pass
